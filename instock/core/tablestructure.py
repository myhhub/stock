...
TABLE_CN_STOCK_FUNDAMENTALS = {'name': 'cn_stock_fundamentals', 'cn': '股票基本面数据',
                               'columns': {'date': {'type': DATE, 'cn': '日期'},
                                           ...
                                           'pe': {'type': FLOAT, 'cn': '市盈率静'},
                                           'pb': {'type': FLOAT, 'cn': '市净率'},
                                           'eps': {'type': FLOAT, 'cn': '每股收益'},
                                           'naps': {'type': FLOAT, 'cn': '每股净资产'},
                                           'pf': {'type': FLOAT, 'cn': '每股公积金'},
                                           'udpps': {'type': FLOAT, 'cn': '每股未分配利润'},
                                           'roe': {'type': FLOAT, 'cn': '加权净资产收益率'},
                                           'gpm': {'type': FLOAT, 'cn': '毛利率'},
                                           'tdr': {'type': FLOAT, 'cn': '资产负债率'},
                                           'revenue': {'type': FLOAT, 'cn': '营业收入'},
                                           'revenuer_yb': {'type': FLOAT, 'cn': '营业收入同比增长'},
                                           'np': {'type': FLOAT, 'cn': '归属净利润'},
                                           'npr_yb': {'type': FLOAT, 'cn': '归属净利润同比增长'},
                                           'report_date': {'type': DATE, 'cn': '报告期'},
                                           'equity_total': {'type': FLOAT, 'cn': '总股本'},
                                           'equity_liquidity': {'type': FLOAT, 'cn': '已流通股份'},
                                           'value_total': {'type': FLOAT, 'cn': '总市值'},
                                           'value_liquidity': {'type': FLOAT, 'cn': '流通市值'},
                                           'industry': {'type': NVARCHAR(20), 'cn': '所处行业'},
                                           'ttm': {'type': DATE, 'cn': '上市时间'}}}
...
STOCK_STATS_DATA = {'name': 'calculate_indicator', 'cn': '股票统计/指标计算助手库',
                    'columns': {'close': {'type': FLOAT, 'cn': '价格'},
                                ...
                                'vhf': {'type': FLOAT, 'cn': 'vhf'},
                                'rvi': {'type': FLOAT, 'cn': 'rvi'}, 'rvis': {'type': FLOAT, 'cn': 'rvis'},

...
TABLE_CN_STOCK_POSITION = {'name': 'cn_stock_position', 'cn': '股票持仓',
                           'columns': {
                               ...
                               'code': {'type': NVARCHAR(20), 'cn': '代码'},
                               'name': {'type': NVARCHAR(50), 'cn': '名称'},
                               'market': {'type': NVARCHAR(20), 'cn': '市场'},
                               ...
                               'market_code': {'type': NVARCHAR(20), 'cn': '市场代码'},
                               ...
                               'circulation_type': {'type': NVARCHAR(20), 'cn': '流通类型'},
                               'profit_loss': {'type': FLOAT, 'cn': '盈亏'},
                               'profit_loss_ratio': {'type': FLOAT, 'cn': '盈亏比例'},
                               'account': {'type': NVARCHAR(20), 'cn': '账户'},
                               'stock_balance': {'type': BIGINT, 'cn': '股票余额'},
                               'stock_category': {'type': NVARCHAR(20), 'cn': '股票类别'},
                           }}

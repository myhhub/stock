...
CN_STOCK_FUND_FLOW = ({'name': 'stock_individual_fund_flow_rank', 'cn': '今日',
                       'columns': {'code': {'type': NVARCHAR(6), 'cn': '代码', 'size': 60},
                                   ...
                                   'new_price': {'type': FLOAT, 'cn': '最新价', 'size': 70},
                                   'change_rate': {'type': FLOAT, 'cn': '涨跌幅', 'size': 70},
                                   'fund_amount_1': {'type': BIGINT, 'cn': '今日主力净流入-净额', 'size': 70},
                                   'fund_rate_1': {'type': FLOAT, 'cn': '今日主力净流入-净占比', 'size': 70},
                                   'fund_amount_super_1': {'type': BIGINT, 'cn': '今日超大单净流入-净额', 'size': 100},
                                   'fund_rate_super_1': {'type': FLOAT, 'cn': '今日超大单净流入-净占比', 'size': 70},
                                   'fund_amount_large_1': {'type': BIGINT, 'cn': '今日大单净流入-净额', 'size': 100},
                                   'fund_rate_large_1': {'type': FLOAT, 'cn': '今日大单净流入-净占比', 'size': 70},
                                   'fund_amount_medium_1': {'type': BIGINT, 'cn': '今日中单净流入-净额', 'size': 100},
                                   'fund_rate_medium_1': {'type': FLOAT, 'cn': '今日中单净流入-净占比', 'size': 70},
                                   'fund_amount_small_1': {'type': BIGINT, 'cn': '今日小单净流入-净额', 'size': 100},
                                   'fund_rate_small_1': {'type': FLOAT, 'cn': '今日小单净流入-净占比', 'size': 70}}},
...
TABLE_CN_STOCK_BLOCKTRADE = {'name': 'cn_stock_blocktrade', 'cn': '股票大宗交易',
                             'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                         ...
                                         'turnover_market_rate': {'type': FLOAT, 'cn': '成交占比流通市值', 'size': 120}}}
...
STOCK_STATS_DATA = {'name': 'calculate_indicator', 'cn': '股票统计/指标计算助手库',
                    'columns': {'close': {'type': FLOAT, 'cn': '价格', 'size': 0},
                                'macd': {'type': FLOAT, 'cn': 'dif', 'size': 70}, 'macds': {'type': FLOAT, 'cn': 'macd', 'size': 70},
                                'macdh': {'type': FLOAT, 'cn': 'histogram', 'size': 70},
                                'kdjk': {'type': FLOAT, 'cn': 'kdjk', 'size': 70}, 'kdjd': {'type': FLOAT, 'cn': 'kdjd', 'size': 70},
                                ...
                                'trix': {'type': FLOAT, 'cn': 'trix', 'size': 70}, 'trix_20_sma': {'type': FLOAT, 'cn': 'trma', 'size': 70},
                                'tema': {'type': FLOAT, 'cn': 'tema', 'size': 70},
                                'cr': {'type': FLOAT, 'cn': 'cr', 'size': 70}, 'cr-ma1': {'type': FLOAT, 'cn': 'cr-ma1', 'size': 70},
                                'cr-ma2': {'type': FLOAT, 'cn': 'cr-ma2', 'size': 70}, 'cr-ma3': {'type': FLOAT, 'cn': 'cr-ma3', 'size': 70},
                                'rsi_6': {'type': FLOAT, 'cn': 'rsi_6', 'size': 70}, 'rsi_12': {'type': FLOAT, 'cn': 'rsi_12', 'size': 70},
                                'rsi': {'type': FLOAT, 'cn': 'rsi', 'size': 70}, 'rsi_24': {'type': FLOAT, 'cn': 'rsi_24', 'size': 70},
                                'vr': {'type': FLOAT, 'cn': 'vr', 'size': 70}, 'vr_6_sma': {'type': FLOAT, 'cn': 'mavr', 'size': 70},
                                'roc': {'type': FLOAT, 'cn': 'roc', 'size': 70}, 'rocma': {'type': FLOAT, 'cn': 'rocma', 'size': 70},
                                'rocema': {'type': FLOAT, 'cn': 'rocema', 'size': 70},
                                'pdi': {'type': FLOAT, 'cn': 'pdi', 'size': 70}, 'mdi': {'type': FLOAT, 'cn': 'mdi', 'size': 70},
                                'dx': {'type': FLOAT, 'cn': 'dx', 'size': 70},
                                'adx': {'type': FLOAT, 'cn': 'adx', 'size': 70}, 'adxr': {'type': FLOAT, 'cn': 'adxr', 'size': 70},
                                'wr_6': {'type': FLOAT, 'cn': 'wr_6', 'size': 70}, 'wr_10': {'type': FLOAT, 'cn': 'wr_10', 'size': 70},
                                'wr_14': {'type': FLOAT, 'cn': 'wr_14', 'size': 70},
                                'cci': {'type': FLOAT, 'cn': 'cci', 'size': 70}, 'cci_84': {'type': FLOAT, 'cn': 'cci_84', 'size': 70},
                                'tr': {'type': FLOAT, 'cn': 'tr', 'size': 70}, 'atr': {'type': FLOAT, 'cn': 'atr', 'size': 70},
                                'dma': {'type': FLOAT, 'cn': 'dma', 'size': 70}, 'dma_10_sma': {'type': FLOAT, 'cn': 'ama', 'size': 70},
                                'obv': {'type': FLOAT, 'cn': 'obv', 'size': 70}, 'sar': {'type': FLOAT, 'cn': 'sar', 'size': 70},
                                'psy': {'type': FLOAT, 'cn': 'psy', 'size': 70}, 'psyma': {'type': FLOAT, 'cn': 'psyma', 'size': 70},
                                'br': {'type': FLOAT, 'cn': 'br', 'size': 70}, 'ar': {'type': FLOAT, 'cn': 'ar', 'size': 70},
                                'emv': {'type': FLOAT, 'cn': 'emv', 'size': 70}, 'emva': {'type': FLOAT, 'cn': 'emva', 'size': 70},
                                'bias': {'type': FLOAT, 'cn': 'bias', 'size': 70},
                                'mfi': {'type': FLOAT, 'cn': 'mfi', 'size': 70}, 'mfisma': {'type': FLOAT, 'cn': 'mfisma', 'size': 70},
                                'vwma': {'type': FLOAT, 'cn': 'vwma', 'size': 70}, 'mvwma': {'type': FLOAT, 'cn': 'mvwma', 'size': 70},
                                'ppo': {'type': FLOAT, 'cn': 'ppo', 'size': 70}, 'ppos': {'type': FLOAT, 'cn': 'ppos', 'size': 70},
                                'ppoh': {'type': FLOAT, 'cn': 'ppoh', 'size': 70},
                                'wt1': {'type': FLOAT, 'cn': 'wt1', 'size': 70}, 'wt2': {'type': FLOAT, 'cn': 'wt2', 'size': 70},
                                ...
                                'dpo': {'type': FLOAT, 'cn': 'dpo', 'size': 70}, 'madpo': {'type': FLOAT, 'cn': 'madpo', 'size': 70},
                                'vhf': {'type': FLOAT, 'cn': 'vhf', 'size': 70},
                                'rvi': {'type': FLOAT, 'cn': 'rvi', 'size': 70}, 'rvis': {'type': FLOAT, 'cn': 'rvis', 'size': 70},
                                'fi': {'type': FLOAT, 'cn': 'fi', 'size': 70}, 'force_2': {'type': FLOAT, 'cn': 'force_2', 'size': 70},
                                'force_13': {'type': FLOAT, 'cn': 'force_13', 'size': 70},
                                'ene_ue': {'type': FLOAT, 'cn': 'ene上轨', 'size': 70}, 'ene': {'type': FLOAT, 'cn': 'ene', 'size': 70},
...
TABLE_CN_STOCK_STRATEGIES = [
    ...
    {'name': 'cn_stock_strategy_backtrace_ma250', 'cn': '回踩年线', 'size': 70, 'func': backtrace_ma250.check,
     'columns': _tmp_columns},
    {'name': 'cn_stock_strategy_breakthrough_platform', 'cn': '突破平台', 'size': 70, 'func': breakthrough_platform.check,
     'columns': _tmp_columns},
    {'name': 'cn_stock_strategy_low_backtrace_increase', 'cn': '无大幅回撤', 'size': 70, 'func': low_backtrace_increase.check,
     'columns': _tmp_columns},
    {'name': 'cn_stock_strategy_turtle_trade', 'cn': '海龟交易法则', 'size': 70, 'func': turtle_trade.check_enter,
     'columns': _tmp_columns},
    {'name': 'cn_stock_strategy_high_tight_flag', 'cn': '高而窄的旗形', 'size': 70, 'func': high_tight_flag.check_high_tight,
     'columns': _tmp_columns},
...
STOCK_KLINE_PATTERN_DATA = {'name': 'cn_stock_pattern_recognitions', 'cn': 'K线形态',
                            'columns': {
                                ...
                                'hanging_man': {'type': SmallInteger, 'cn': '上吊线', 'size': 70, 'func': tl.CDLHANGINGMAN},
                                'hikkake_pattern': {'type': SmallInteger, 'cn': '陷阱', 'size': 70, 'func': tl.CDLHIKKAKE},
                                'modified_hikkake_pattern': {'type': SmallInteger, 'cn': '修正陷阱', 'size': 70,
                                                             'func': tl.CDLHIKKAKEMOD},
                                'in_neck_pattern': {'type': SmallInteger, 'cn': '颈内线', 'size': 70, 'func': tl.CDLINNECK},
                                'on_neck_pattern': {'type': SmallInteger, 'cn': '颈上线', 'size': 70, 'func': tl.CDLONNECK},
                                'thrusting_pattern': {'type': SmallInteger, 'cn': '插入', 'size': 70, 'func': tl.CDLTHRUSTING},
                                ...
                                'belt_hold': {'type': SmallInteger, 'cn': '捉腰带线', 'size': 70, 'func': tl.CDLBELTHOLD},
                                ...
                                'evening_star': {'type': SmallInteger, 'cn': '暮星', 'size': 70, 'func': tl.CDLEVENINGSTAR},
                                ...
                                'harami_pattern': {'type': SmallInteger, 'cn': '母子线', 'size': 70, 'func': tl.CDLHARAMI},
                                'harami_cross_pattern': {'type': SmallInteger, 'cn': '十字孕线', 'size': 70,
                                                         'func': tl.CDLHARAMICROSS},
                                'homing_pigeon': {'type': SmallInteger, 'cn': '家鸽', 'size': 70, 'func': tl.CDLHOMINGPIGEON},
                                ...
                                'kicking_bull_bear': {'type': SmallInteger, 'cn': '由较长缺影线决定的反冲形态', 'size': 70,
                                                      'func': tl.CDLKICKINGBYLENGTH},
                                'ladder_bottom': {'type': SmallInteger, 'cn': '梯底', 'size': 70, 'func': tl.CDLLADDERBOTTOM},
                                'long_line_candle': {'type': SmallInteger, 'cn': '长蜡烛', 'size': 70, 'func': tl.CDLLONGLINE},
                                ...
                                'morning_star': {'type': SmallInteger, 'cn': '晨星', 'size': 70, 'func': tl.CDLMORNINGSTAR},
                                ...
                                'spinning_top': {'type': SmallInteger, 'cn': '纺锤', 'size': 70, 'func': tl.CDLSPINNINGTOP},
                                ...
                                'tristar_pattern': {'type': SmallInteger, 'cn': '三星', 'size': 70, 'func': tl.CDLTRISTAR},

...
**2023-7-11 优化K线图可视化，自适应手机小屏。**

**2023-7-6 增加“股票关注”功能，关注股票在各模块(含有的)置顶、标红显示。若软件不显示数据，参照https://github.com/myhhub/stock/issues/36  解决**

**2023-6-28 可视化支持移动设备。**

**2023-6-27 增加“股票分红配送”模块。**

**项目计划：1.爬取任何想要的数据；2.开发选股模块，支持各种条件组合选股；3.升级查询功能，支持任意检索。**
...
包括每日股票数据、股票资金流向、股票分红配送、股票龙虎榜、股票大宗交易、股票基本面数据、每日ETF数据。
